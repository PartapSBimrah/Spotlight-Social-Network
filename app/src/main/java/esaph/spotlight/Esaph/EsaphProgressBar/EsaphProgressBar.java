...
package esaph.spotlight.Esaph.EsaphProgressBar;
...
public class EsaphProgressBar extends View {
    ...
    public EsaphProgressBar(Context context) {
        this(context, null);
    }

    public EsaphProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EsaphProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    }

    @RequiresApi(21)
    public EsaphProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
