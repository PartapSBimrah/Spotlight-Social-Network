...
public class VideoViewAware extends ViewAware
{
	public VideoViewAware(EsaphTextureVideoView esaphTextureVideoView)
	{
		super(esaphTextureVideoView);
	}
	 ...
	 *                            <p/>
	 */
	public VideoViewAware(ImageView imageView, boolean checkActualViewSize) {
	...
	@Override
	public EsaphTextureVideoView getWrappedView() {
		return (EsaphTextureVideoView) super.getWrappedView();
	}
