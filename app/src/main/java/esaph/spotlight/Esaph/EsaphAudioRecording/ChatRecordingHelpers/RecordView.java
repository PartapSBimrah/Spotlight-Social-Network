...
import esaph.spotlight.Esaph.EsaphShimmerLayout.ShimmerLayout;
...
public class RecordView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs != null && defStyleAttr == -1 && defStyleRes == -1) {
            ...
            int slideArrowResource = typedArray.getResourceId(R.styleable.RecordView_esc_slide_to_cancel_arrow, -1);
            String slideToCancelText = typedArray.getString(R.styleable.RecordView_esc_slide_to_cancel_text);
            int slideMarginRight = (int) typedArray.getDimension(R.styleable.RecordView_esc_slide_to_cancel_margin_right, 30);
            int counterTimeColor = typedArray.getColor(R.styleable.RecordView_esc_counter_time_color, -1);
            int arrowColor = typedArray.getColor(R.styleable.RecordView_esc_slide_to_cancel_arrow_color, -1);


            int cancelBounds = typedArray.getDimensionPixelSize(R.styleable.RecordView_esc_slide_to_cancel_bounds, -1);
