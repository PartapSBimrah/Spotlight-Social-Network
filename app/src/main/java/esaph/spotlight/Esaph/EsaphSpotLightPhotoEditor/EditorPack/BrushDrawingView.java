...
public class BrushDrawingView extends View
{
    ...
    private EsaphShader shaderEffect;
    public void setShaderEffect(EsaphShader shaderEffect)
    {
        if(shaderEffect != null)
        {
            shaderEffect.onLayout(getHeight(), getWidth());
        }
    ...
    protected void onDraw(Canvas canvas)
    {
        if(shaderEffect != null)
        {
            shaderEffect.onDrawShader(mDrawPaint);
        }
    ...
    public static class PathEffectDotsMinMax
    {
        public static final float[] DEFAULT = new float[]{5f, 10f};
    }

    public static class PathEffectInterruptedLineMinMax
    {
        public static final float[] DEFAULT = new float[]{50f, 10f};
    }
    ...
    public EsaphShader getShaderEffect() {
        return shaderEffect;
    }
}