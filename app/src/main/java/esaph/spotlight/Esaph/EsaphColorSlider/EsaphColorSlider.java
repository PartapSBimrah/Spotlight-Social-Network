...
package esaph.spotlight.Esaph.EsaphColorSlider;
...
public class EsaphColorSlider extends View
{
    ...
    public EsaphColorSlider(Context context) {
        this(context, null);
    }

    public EsaphColorSlider(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EsaphColorSlider(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private boolean processTouch(MotionEvent event)
    {
        ...
        else if (event.getAction() == MotionEvent.ACTION_MOVE || event.getAction() == MotionEvent.ACTION_UP)
        {
            ...
            {
                mListener.onReleasedColorPicker();
            }
