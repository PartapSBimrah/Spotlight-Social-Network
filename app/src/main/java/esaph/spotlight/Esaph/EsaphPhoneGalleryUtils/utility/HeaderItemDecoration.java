...
public class HeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (CameraBottomSheetUtility.isNull(topChild)) {
            return;
        }
        ...
        currentHeader.setPadding((int) (currentHeader.getPaddingLeft() - CameraBottomSheetUtility.convertPixelsToDp(5, context)),
        ...
        if (CameraBottomSheetUtility.isNull(childInContact)) {
