...
package esaph.spotlight.Esaph.EsaphBubbleSeekBar;
...
import static esaph.spotlight.Esaph.EsaphBubbleSeekBar.BubbleUtils.dp2px;
import static esaph.spotlight.Esaph.EsaphBubbleSeekBar.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSecondTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_second_track_color,
                ContextCompat.getColor(context, R.color.colorPrimaryChat));
