...
public class EsaphViewDragHelper
{
    ...
    public abstract static class Callback {
         ...
         * and the view capture will not fully end until it comes to a complete pauseAndSeekToZero.
         * If neither of these methods is invoked before <code>onViewReleased</code> returns,
         * the view will pauseAndSeekToZero in place and the ViewDragHelper will return to
         * {@link #STATE_IDLE}.</p>
         *
     ...
     */
    public static EsaphViewDragHelper create(@NonNull ViewGroup forParent, @NonNull ViewDragHelper.Callback cb) {
        return new EsaphViewDragHelper(forParent.getContext(), forParent, cb);
    }
     ...
     * @return a new ViewDragHelper instance
     */
    public static EsaphViewDragHelper create(@NonNull ViewGroup forParent, float sensitivity,
                                        @NonNull ViewDragHelper.Callback cb) {
        final EsaphViewDragHelper helper = create(forParent, cb);
    ...
    private EsaphViewDragHelper(@NonNull Context context, @NonNull ViewGroup forParent,
                           @NonNull ViewDragHelper.Callback cb) {
        if (forParent == null) {
