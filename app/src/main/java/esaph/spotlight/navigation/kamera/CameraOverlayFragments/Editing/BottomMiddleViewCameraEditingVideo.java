...
public class BottomMiddleViewCameraEditingVideo extends EsaphBottomMiddleViewFragment
{
    ...
    private CameraEditorVideo cameraEditorVideo;
    private SwipeNavigation swipeNavigation;

    private EsaphTagFragment esaphTagFragment;

    public BottomMiddleViewCameraEditingVideo()
    {
        // Required empty public constructor
    }

    public static BottomMiddleViewCameraEditingVideo getInstance()
    {
        return new BottomMiddleViewCameraEditingVideo();
    }
    ...
    public void onAttach(Context context)
    {
        ...
        if(context instanceof SwipeNavigation)
        {
            ...
            cameraEditorVideo = (CameraEditorVideo)
                    swipeNavigation.getSupportFragmentManager().findFragmentById(R.id.cameraEditorVideo);
        }
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable final Bundle savedInstanceState)
    {
            ...
            public void onClick(final View v)
            {
                ...
                if(activity != null && !activity.isFinishing())
                {
                    if(dialogSendInfo == null) dialogSendInfo = DialogSendInfo.getInstance(new DialogSendInfo.ChooseReceiversListener()
                    {
                        ...
                        {
                            cameraEditorVideo.preparePostAndStartUploading(
                                    jsonArrayReceivers,
        ...
        imageViewShaderEffects.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(final View v)
            {
                Toast.makeText(getContext(), getResources().getString(R.string.txt_still_working), Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void onBitmapReady()
    {
        ...
        mImageFilterView.setSourceBitmap(cameraEditorVideo.getBitmapLastPic());
    ...
    public void savePictureOrVideo()
    {
        ...
        try
        {
            ...
            if(imageViewSavePicture.getTag() != null && !imageViewSavePicture.getTag().equals("F"))
            {
                if(imageViewSavePicture.getTag().equals("C")) //Image saved, delete it again.
                {
                    File fileVideo = new File(
                            Environment.getExternalStorageDirectory()
                                    + File.separator + getResources().getString(R.string.app_name)
                                    + File.separator + getResources().getString(R.string.app_name) + "#" + cameraEditorVideo.getShootTime() + ".mp4");
                    fileVideo.delete();
            ...
            else
            {
                ...
                {
                    InputStream in = new FileInputStream(cameraEditorVideo.getFileVideoToDisplay());
                    try
                    {
    ...
    public EditText getEditTextBeschreibung()
    {
        return editTextBeschreibung;
    }
