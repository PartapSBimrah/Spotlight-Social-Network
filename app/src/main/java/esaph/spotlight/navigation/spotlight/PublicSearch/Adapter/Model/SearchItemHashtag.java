...
public class SearchItemHashtag
{
    ...
    public SearchItemHashtag(long UID, String Username, String Vorname, short watchingStatus, String Land) //For User //Letzte Variable ist Useless.
    {
        this.UID = UID;
