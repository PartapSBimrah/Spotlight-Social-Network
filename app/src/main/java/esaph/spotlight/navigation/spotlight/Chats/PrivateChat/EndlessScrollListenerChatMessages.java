...
public abstract class EndlessScrollListenerChatMessages implements AbsListView.OnScrollListener
{
    ...
    public EndlessScrollListenerChatMessages()
    {
    }
...
*/
        ...
        if (!loading && (firstVisibleItem + visibleItemCount + visibleThreshold) >= totalItemCount ) {
            loading = true;
            loadMoreAllPrivateMomentsGallery();
        }*/
    }
